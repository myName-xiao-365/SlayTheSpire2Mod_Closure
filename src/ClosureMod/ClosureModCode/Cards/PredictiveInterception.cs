...
public sealed class PredictiveInterception : ModCardTemplate
{
    ...
    public PredictiveInterception() : base(BaseEnergyCost, CardKind, CardRarityValue, CardTarget, ShowInCardLibrary)
    {
    }
