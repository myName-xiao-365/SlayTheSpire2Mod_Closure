...
public sealed class SecondResponse : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(
        PortraitPath: $"{Entry.ResPath}/images/cards/SecondResponse.png");
    ...
    public SecondResponse() : base(BaseEnergyCost, CardKind, CardRarityValue, CardTarget, ShowInCardLibrary)
    {
    }
